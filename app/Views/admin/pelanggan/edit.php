        ...
        <div class="main-content">
            ...
            <nav class="main-header">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <h6 class="navbar-title d-none d-sm-block">Pembaruan Data</h6>
                </div>
            ...
            <main class="content-wrapper">
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-2">
                    <div>
                        ...
                        <p class="text-muted mb-0">Ubah dan perbarui informasi kontak pelanggan.</p>
                    </div>
                        ...
                        <div class="card card-accent-top">
                            <div class="card-header bg-white">
                                <h5 class="card-title mb-0">
                                    <i class="fa-solid fa-user-pen me-2" style="color: var(--tech-primary);"></i>
                                    Formulir Edit Pelanggan
                                </h5>
                            </div>

                            <form action="<?= base_url('admin/pelanggan/update/' . $pelanggan['id_pelanggan']); ?>"
                                method="post">
                                <?= csrf_field(); ?>
                    ...
                    <div class="col-lg-4 d-none d-lg-block">
                        <div class="card border-0 bg-primary text-white shadow-sm"
                            ...
                            <div class="card-body p-4 text-center">
                                <i class="fa-solid fa-user-shield mb-3"
                                    style="font-size: 3rem; color: var(--tech-accent);"></i>
                                <h5 class="fw-bold mb-3">Keamanan Data Klien</h5>
                                <p class="mb-0 fs-6" style="color: #cbd5e1; line-height: 1.6;">
                                    Pastikan data yang Anda perbarui akurat. Data kontak (Nomor HP & Alamat) ini akan
                                    digunakan sebagai referensi utama pada saat pembuatan struk/invoice transaksi di
                                    masa mendatang.
                                </p>
                            </div>
                        </div>
